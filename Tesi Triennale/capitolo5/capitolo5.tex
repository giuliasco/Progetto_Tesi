\chapter{Conclusioni}
Nel presente lavoro di testi \`e stata descrittao  un algoritmo per il conteggio di $ k $-treelet basato sulla tecnica del Color Coding (capitolo \ref{cap 2}). %TODO ho rimosso nuvamente "la fase di costruzione". Come ti ho detto, cerchiamo di non fare continuamente riferimento ad una fase di un algoritmo che alla fine a noi NON interessa.
...
Si \`e visto come, in questa tesi, l'algoritmo sia stato sviluppato con un approccio basato sulle unioni tra alberi piuttosto che sulle scomposizioni e %TODO Al momento il concetto di unione non è  mai discusso
...
Anche per questo nuovo algoritmo, come per il precedente, il conteggio dei $ k $-treelet basandoci sull'unione piuttosto che sulle decomposizioni. %TODO Idem
